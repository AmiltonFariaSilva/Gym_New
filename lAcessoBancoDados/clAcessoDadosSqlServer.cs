...
using lAcessoBancoDados.Properties;


namespace lAcessoBancoDados
{
    public class clAcessoDadosSqlServer
    {
        //Cria a conexão
        ...
        public object ExecutarManipulacao(CommandType commandType, string nomeStoredProcedureOuTextoSql)
        {
            try
            {
                ...
                //Colocando as coisas dentro do comando (dentr da caixa que vai trafegar na conexão)
